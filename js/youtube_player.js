...
(function ( $, window, document, undefined ) {
  ...
  function Plugin(element, options ) {
	  ...
	  this._showinfo = (this.options.showinfo) ? '&showinfo=1' : '';
      this.init();
  }
  ...
  Plugin.prototype = {
      ...
      getOldEmbedCode: function(options, id) {
        ...
        html += '<param name="movie" value="' + this._protocol + 'www.youtube.com/v/' + id + this._autoPlay + this._showRelated + this._fullScreen + this._showinfo  + '"> </param>';
        html += '<param name="wmode" value="transparent"> </param>';
        if(options.allowFullScreen) {
          html += '<param name="allowfullscreen" value="true"> </param>';
        }
        html += '<embed src="' + this._protocol + 'www.youtube.com/v/' + id + this._autoPlay + this._showRelated + this._fullScreen + this._showinfo + '"';
        if(options.allowFullScreen) {
